...
\label{subsubsec:clang} Un altro strumento di analisi statica utilizzato è \texttt{clang}\footnote{Sito:
...
\label{subsubsec:frama-c} L'ultimo strumento di analisi statica utilizzato sul progetto
