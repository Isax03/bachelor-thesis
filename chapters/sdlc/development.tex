...
direttamente queste problematiche. Alcune di esse, come \texttt{safe-malloc} o
\texttt{xmalloc}, fungono da wrapper per le funzioni di allocazione (malloc, free,
...
\texttt{safestringlib}, sostituiscono le funzioni standard per la manipolazione delle
...
libreria \texttt{Sailfish Pool}, invece, introduce tecniche come la preallocazione
