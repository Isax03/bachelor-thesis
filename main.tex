...
% Ragged bottom: avoid page stretching
\raggedbottom
...
% Citation as superscript (replaces [N] notation)
...
\lstset{ language=C, basicstyle=\ttfamily\small, keywordstyle=
\color{blue}
, commentstyle=
...
\begin{document}
  ...
  \bibliographystyle{unsrt} % plain for alphabetical order, unsrt for order of appearance
